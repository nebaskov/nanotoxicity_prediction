...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('core_composition', models.CharField(max_length=50, verbose_name='Chemical formula of core')),
                ('coat_composition', models.CharField(max_length=50, null=True, verbose_name='Chemical formula of coating')),
                ('av', models.CharField(default='', max_length=250, verbose_name='Area/volume')),
                ('mm', models.CharField(default='', max_length=250, verbose_name='Max(size)/min(size)')),
                ('magnetic_moment_core', models.CharField(default='', max_length=50, verbose_name='Magnetic moment of core')),
                ('sum_surface_spins', models.CharField(default='', max_length=50, verbose_name='Sum surface spins')),
                ('sat_magn', models.CharField(default='', max_length=50, verbose_name='Saturation magnetization')),
                ('coerc', models.CharField(max_length=50, verbose_name='Coercitivity')),
                ('rem_magn', models.CharField(max_length=50, verbose_name='Remanence magnetization')),
                ('magnetic_moment_coating', models.CharField(max_length=50, verbose_name='Magnetic moment of inorganic coating')),
                ('logp', models.CharField(max_length=50, verbose_name='LogP of organic coating')),
                ('hacceptors', models.CharField(max_length=50, verbose_name='Number of H acceptors of organic coating')),
                ('field_strenght', models.CharField(default='', max_length=50, verbose_name='Strenth of field')),
            ],
        ),
        migrations.CreateModel(
            name='PredictionActBase',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('core_composition', models.CharField(max_length=50, verbose_name='Chemical formula of core')),
            ],
